...
<div data-aos=" fade-up" class=" w-[250px] lg:w-[330px] bg-white rounded-lg border border-cyan-500 shadow-md dark:bg-sky-800 dark:border-cyan-700 flex-col justify-center">
    ...
    <img src={rental} alt="demo img"  className="w-[200px] lg:w-[270px] rounded-lg place-items-center  ml-[28px] mt-[20px] shadow-2xl hover:brightness-50"/>
...
<div data-aos=" fade-up" class=" w-[250px] lg:w-[330px] bg-white rounded-lg border border-cyan-500 shadow-md dark:bg-sky-800 dark:border-cyan-700 flex-col justify-center">
    ...
    <img src={news} alt="demo img"  className="w-[200px] lg:w-[270px] rounded-lg place-items-center  ml-[28px] mt-[20px] shadow-2xl hover:brightness-50"/>
...
<div data-aos=" fade-up" class=" w-[250px] lg:w-[330px] bg-white rounded-lg border border-cyan-500 shadow-md dark:bg-sky-800 dark:border-cyan-700 flex-col justify-center">
    ...
    <img src={expense} alt="demo img"  className="w-[200px] lg:w-[270px] rounded-lg place-items-center  ml-[28px] mt-[20px] shadow-2xl hover:brightness-50"/>
    
    <div class="p-5">
       
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-center  text-white">Expence Tracker</h5>
        
       
    <div className='flex justify-center'>
    <button className="bg-transparent hover:bg-cyan-500 text-cyan-500 font-semibold hover:text-white py-1 px-2 md:py-2 md:px-4 border border-cyan-500 hover:border-transparent rounded justify-center">
       <a href="https://github.com/mohan062002/shoping_app"> Github</a>
     </button>
